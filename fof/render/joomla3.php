...
class F0FRenderJoomla3 extends F0FRenderStrapper
{
	...
	public function preRender($view, $task, $input, $config = array())
	{
		...
		if ($platform->isBackend())
		{
            ...
            $release = JVersion::MAJOR_VERSION.'.'.JVersion::MINOR_VERSION;
            $versionParts = explode('.', $release);*/
			$minorVersion = JVersion::MINOR_VERSION;//str_replace('.', '', $version->RELEASE);
			$majorVersion = JVersion::MAJOR_VERSION;//array_shift($versionParts);
