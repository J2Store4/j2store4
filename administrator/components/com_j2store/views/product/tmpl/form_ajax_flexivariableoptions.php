                ...
                <h4 class="panel-title">
                    <div class="pull-right">
                        <?php if( $this->variant->isdefault_variant):?>
                            <a id="default-variant-<?php echo $this->variant->j2store_variant_id;?>" class="btn btn-micro hasTooltip <?php echo $btn_class; ?> " title="" onclick="return listVariableItemTask(<?php echo $this->variant->j2store_variant_id;?>,'unsetDefault',<?php echo $this->variant->product_id;?>)" href="javascript:void(0);" data-original-title="UnSet default">
                                <i class="icon-featured"></i>
                            </a>
                        <?php else:?>
                            <a id="default-variant-<?php echo $this->variant->j2store_variant_id;?>"
                               class="btn btn-micro hasTooltip <?php echo $btn_class; ?>" title="" onclick="return listVariableItemTask(<?php echo $this->variant->j2store_variant_id;?>,'setDefault',<?php echo $this->variant->product_id;?>)" href="javascript:void(0);" data-original-title="Set default">
                                <i class="<?php echo $star_icon; ?>"></i>
                            </a>
                        <?php endif;?>
                        &nbsp;
                        &nbsp;
                        <a class="btn btn-danger <?php echo $btn_class; ?>"
                    ...
                    <a data-toggle="collapse"  data-bs-toggle="collapse" data-bs-target="#collapse<?php echo $this->variant->j2store_variant_id;?>"  data-parent="#accordion" href="#collapse<?php echo $this->variant->j2store_variant_id;?>">
            ...
            <div id="collapse<?php echo $this->variant->j2store_variant_id;?>"
                ...
                <div class="panel-body">
                    <div class="<?php echo $row_class;?>">
                        ...
                        <div class="<?php echo $col_class;?>5">
                            <div class="control-group">
                        ...
                        <div class="<?php echo $col_class;?>4">
                            <?php if(J2Store::isPro() == 1) : ?>
                                <div class="j2store-product-general">
                                    ...
                                    <?php echo J2Html::hidden($prefix.'[isdefault_variant]',  (isset($this->variant->isdefault_variant))?$this->variant->isdefault_variant : '',array('class'=>'input','id' => 'productquantity_'.$this->variant->j2store_variant_id)); ?>
                                    <div class="control-group">
